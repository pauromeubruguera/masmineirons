            ...
            <div className="mainPage">
                ...
                <section>
                    <div className="pt-[0%] pr-[8%] pl-[8%]">
                        ...
                        <p>
                            ...
                            qualsevol cosa que ell els hi demanés:
                ...
                <section>
                    <div className="flex justify-evenly">
                        <div className="pt-[10%] pr-[5%] pl-[28%] w-8/12 relative">
                            <Image
                                width={3508}
                                height={4961}
                ...
                <section>
                    <div className="flex justify-evenly">
                        <div className="pt-[15%] pr-[5%] pl-[28%] w-8/12 relative">
                            <Image
                                width={3508}
                                height={4961}
                    ...
                    <div className="flex justify-evenly">
                        ...
                        <div className="pt-[6%] pr-[7%] pl-[7%] w-7/12">
                            <div className="text-center pb-[5%]">
                                ...
                                <div className="text-[16px] leading-[9px] font-semibold">
                                    Formato especial 3L - Bag in Box
                                </div>
                            </div>
                            <p>
